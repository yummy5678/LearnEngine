...
{	
	if(m_GraphicsFamilyIndex == UndefinedQueueNumber) m_GraphicsFamilyIndex = SearchGraphicsFamily();
...
{
	if (m_ComputeFamilyIndex == UndefinedQueueNumber) m_ComputeFamilyIndex = SearchComputeFamily();
...
{
	if (m_TransferFamilyIndex == UndefinedQueueNumber) m_TransferFamilyIndex = SearchTransferFamily();
...
{
	if (m_PresentationFamilyIndex == UndefinedQueueNumber) m_PresentationFamilyIndex = SearchPresentationFamily(surface);
